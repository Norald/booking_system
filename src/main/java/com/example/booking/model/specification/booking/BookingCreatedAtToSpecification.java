...
public class BookingCreatedAtToSpecification implements Specification<Booking> {
    ...
    public BookingCreatedAtToSpecification(FilterValueRequestScope filterValueRequestScope) {
    ...
    public Predicate toPredicate(Root<Booking> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        return criteriaBuilder.lessThanOrEqualTo(root.get("createdAtFrom"), date);
    }
